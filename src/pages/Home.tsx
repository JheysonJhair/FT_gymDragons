              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-lg-5 col-xl-4">
                    ...
                    <div className="mb-4">
                      <p className="mb-2">
                        <i className="flag-icon flag-icon-gb me-1" /> England{" "}
                    ...
                    <div className="mb-4">
                      <p className="mb-2">
                        <i className="flag-icon flag-icon-au me-1" /> Australia{" "}
                ...
                <div className="card radius-10 mb-0 border shadow-none">
                  <div className="card-body">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="widgets-icons-2 bg-gradient-kyoto text-dark ms-auto">
